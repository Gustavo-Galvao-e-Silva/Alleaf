...
export function Orb({
  ...
  return (
    <div className={className ?? "relative h-2.5px w-2.5px"} style={style}>
      <Canvas
...
void main() {
    ...
    // Blend both rings with feathered edges for a softer border fade
    float ringFade1 = 0.22;
    float ringFade2 = 0.28;
    float ringAlpha1 = smoothstep(ringRadius1 - ringFade1, ringRadius1 + ringFade1, inputRadius2) * opacity1;
    float ringAlpha2 = smoothstep(ringRadius2 - ringFade2, ringRadius2 + ringFade2, inputRadius1) * opacity2;
